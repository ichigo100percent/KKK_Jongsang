...
Node* Octree::CreateNode(Node* pParent, TSpaceData data)
{
    Node* pNode = new Node(m_iNumNodeCounter++);
    pNode->SetParent(pParent);
...
void Octree::BuildTree(Node* pNode)
{
   ...
   Vector3 vTC1 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y,
                     pNode->m_tBox.m_Min.z };
   Vector3 vRC1 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Min.z };
   Vector3 vBC1 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Min.z };
   Vector3 vLC1 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Min.z };

   Vector3 vTC2 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y,
                    pNode->m_tBox.m_Center.z };
   Vector3 vRC2 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Center.z };
   Vector3 vBC2 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Center.z };
   Vector3 vLC2 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Center.z };

   Vector3 vTC3 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[0].y,
                    pNode->m_tBox.m_Max.z };
   Vector3 vRC3 = { pNode->m_tBox.m_Point[1].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Max.z };
   Vector3 vBC3 = { pNode->m_tBox.m_Center.x, pNode->m_tBox.m_Point[3].y,
                    pNode->m_tBox.m_Max.z };
   Vector3 vLC3 = { pNode->m_tBox.m_Point[0].x, pNode->m_tBox.m_Center.y,
                    pNode->m_tBox.m_Max.z };

...
void DxWrite::Draw30(float x, float y, std::wstring msg, D2D1::ColorF color)
{
	m_pRT->BeginDraw();
...
void DxWrite::Draw20(float x, float y, std::wstring msg, D2D1::ColorF color)
{
	m_pRT->BeginDraw();
	D2D1_RECT_F rtf = { x, y, 800.0f, 600.0f };
	m_pDefaultBrush->SetColor(color);
...
bool DxWrite::Init(ComPtr<IDXGISurface> dxgiSurface)
{
